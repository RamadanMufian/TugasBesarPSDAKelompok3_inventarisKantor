...
#include "ui_inventarisadmin.h"
#include <QMessageBox>
#include "mainwindow.h"

inventarisadmin::inventarisadmin(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::inventarisadmin)
{
    ui->setupUi(this);
}

inventarisadmin::~inventarisadmin()
{
    delete ui;
}

void inventarisadmin::on_pushButton_clicked()
{
...
void inventarisadmin::on_pushButton_2_clicked()
{
...
void inventarisadmin::displayData()
{
...
void inventarisadmin::on_pushButtonCari_clicked()
{
...
int inventarisadmin::binarySearch(const QVector<Item> &array, const QString &key)
{
    int left = 0;
...
void inventarisadmin::on_pushButton_3_clicked()
{
...
void inventarisadmin::on_pushButton_4_clicked()
{
...
void inventarisadmin::on_tableWidget_cellActivated(int row, int column)
{
